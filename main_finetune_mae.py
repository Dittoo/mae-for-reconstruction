...
from engine_finetune_mae import train_one_epoch, evaluate


def get_args_parser():
    parser = argparse.ArgumentParser('MAE fine-tuning for anomaly detection', add_help=False)
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='mae_pretrain_vit_base_full.pth',
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='screw', type=str,
                        help='dataset path')
